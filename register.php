<div class="container-fluid bg-light py-4 mb-5">
        <div class="container text-center py-2">
            <h1 class="display-6 fw-bold text-dark mb-2">User Register</h1>
                ...
                <div class="col-lg-6 col-md-8">
                    <div class="card border-0 shadow-sm rounded-4 p-4 p-md-5">
                        ...
                        <div class="text-center mb-4">
                            ...
                            <p class="text-muted">Reset your password to login to your account.</p>
                        </div>
                        ...
                        <form action="login_process.php" method="POST">
                            ...
                            <!-- User name Input -->
                            <div class="mb-4">
                                <label for="username" class="form-label text-dark fw-medium">User Name</label>
                                <div class="input-group border rounded-pill overflow-hidden">
                                    ...
                                    <input type="text" class="form-control border-0 py-3 pe-3" id="username" name="username" placeholder="John Doe" required>
                                </div>
                            </div>
